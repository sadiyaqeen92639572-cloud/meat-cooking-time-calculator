...
function calcWidget(cfg) {
  ...
  const weightField = cfg.fixedWeight
    ...
    : `<div class="form-group"><label>Weight (kg)</label><input type="number" id="wNum" min="0.2" max="12" step="0.1" value="${cfg.defaultWeight || 2}" placeholder="e.g. 2"></div>
  ...
  <div class="tool-card">
    ...
    <div class="result" id="result">
      ...
      <div class="result-grid" style="margin-bottom:14px;">
        ...
        <div class="r-stat"><div class="sv" id="r-perkg"></div><div class="sl">Per kg</div></div>
      </div>
  ...
  function calculate(){
    const kg = parseFloat(document.getElementById('wNum').value)||0;
    if(kg<=0){ alert('Please enter a weight in kg.'); return; }
    ...
    document.getElementById('r-sub').textContent = (PAGE.mode==='doneness'? d.label+' · ' : '') + kg+' kg · '+(oven==='conv'?'conventional':'fan')+' oven';
